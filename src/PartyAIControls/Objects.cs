...
namespace PartyAIControls
{
    public class PartyAIClanPartySettings
    {
        ...
        internal void ResetBudgets()
        {
            ...
            TroopsConvertibleToday = SubModule.PartyAIClanPartySettingsManager.TroopsConvertedPerDay > 0 ? SubModule.PartyAIClanPartySettingsManager.TroopsConvertedPerDay : int.MaxValue;
        }
